...
export default function Dropdown({
  ...
  return (
    <div
      ref={dropdownRef}
      className={join(
        'bg-surface-light dark:bg-surface-dark animate-slide-down z-20 absolute top-full mt-0.5 sm:mt-1.5 w-48 origin-top transform rounded-md py-1 shadow-lg transition-transform duration-1000 ease-out max-h-[calc(100svh-8rem)] overflow-y-auto',
        className,
      )}
    >
      {children}
